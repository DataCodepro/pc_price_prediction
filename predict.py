...
le_drive_size = data["le_drive_size"]
le_processor = data["le_processor"]
le_processor_speed = data["le_processor_speed"]
le_screen_r_width = data["le_screen_r_width"]
le_screen_r_height = data["le_screen_r_height"]
def show_predict_page():
    ...
    model_1 =('hdd', 'ssd', 'sdd', 'SSD', 'hhd')
    drive_size=('320', '0' ,'256' ,'500' ,'512', '1000', '1TB', '128', '64', '32', '180', '51GB', '250','120')
    ram=(4, 16 , 8 ,32 , 2, 12,  3, 24)
    processor=('i7', 'i5', 'AMD', 'i3', 'Xeon', 'atom', 'A6' ,'celeron', '2 duo', 'pentium' ,'E1')
    gen = (2. , 8., 10. , 4.,  1., 11.,  9.,  6.,  7.,  5. , 3.,  0.)
    processor_speed =('2.7', '0', '2.5', '2.6', '3.8', '2.4', '1.99', '2.8', '1.6' ,'2', '2.9' ,'1.5', '1.8',
 ...
 11. , 17.,  15.4 , 0.,  13.5,)
    screen_width =('1366', '1920', '1600', '3200', '3840', '2736', '1280', '2560', '0' ,'3480')
    screen_height = ('768', '1080', '900', '1800', '2160' ,'1280', '1824' ,'800' ,'1600', '0')
    touch_screen = (0., 1.)
    keyboard_light = (0., 1.)
    hdmi = (0.,1.)
